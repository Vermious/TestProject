            ...
            <div class="container mx-auto">
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                        <h4 class="text-dark mb-1 text-xl font-bold">Onze locatie</h4>
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div class="w-full">
                        <h4 class="text-dark mb-1 text-xl font-bold">Telefoon nummer</h4>
                        <p class="text-body-color text-base">Nog niet beschikbaar</p>
                        </div>
                    </div>
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div
                        ...
                        <div class="w-full">
                        <h4 class="text-dark mb-1 text-xl font-bold">Email Adres</h4>
                        <p class="text-body-color text-base">padelbuddies@gmail.com</p>
                        </div>
                    </div>
                    </div>
                </div>
