<template>
    <AppLayout title="AttributeEntryCreate">
      <jet-form-section @submitted="createGroupName()">
          ...
          <div class="border-b border-gray-900/10 pb-12">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div class="sm:col-span-2">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                        <button @click="createGroupName" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
                            Maak groep aan
                        </button>
                    </div>
                </div>
