      ...
      <div class="w-full mb-12 xl:mb-0 mx-auto mt-2">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
          <div class="rounded-t mb-0 px-4 py-3 border-0">
            ...
            <div class="flex flex-wrap items-center">
              <div class="relative w-full pl-1 pr-4 max-w-full flex-grow flex-1">
                <h3 class="font-semibold text-base text-blueGray-700">Bookings overview</h3>
              </div>
          ...
          <div class="block w-full overflow-x-auto">
            <table :v-if="pageData.bookings?.length > 0" class="items-center bg-transparent w-full border-collapse">
              ...
              <tbody class="bg-white divide-y divide-gray-300">
                <tr v-for="booking in pageData.bookings" :key="booking.id" class="whitespace-nowrap">
                  <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4">
                    <div class="text-sm text-gray-900">
                        Padel court: {{ booking.padel_court }}
                    </div>
                  </td>
