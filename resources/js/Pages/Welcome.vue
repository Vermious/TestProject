    ...
    <AppLandingsPage>
        ...
        <section class="w-full px-4">
            <div class="mx-auto max-w-3xl text-center">
                <h3 class="mb-6 text-3xl font-bold">Review</h3>
            ...
            <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6 mb-8">
                <figure class="max-w-screen-md mx-auto">
                    ...
                    <figcaption class="flex items-center justify-center mt-6 space-x-3">
                        <img class="w-6 h-6 rounded-full" src="/assets/images/stock-img.jpg" alt="profile picture">
                        <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                            <div class="pr-3 font-medium text-gray-900 dark:text-white">Name Here</div>
                            <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Function here</div>
                        </div>
                    </figcaption>
                </figure>
            </div>
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div class="grid gap-8 lg:grid-cols-2">
                    <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a :href="route('blog.show')">Title blog 1</a></h2>
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.</p>
                        <div class="flex justify-between items-center">
                            <div class="flex items-center space-x-4">
                                <div class="h-8 w-8">
                                    <img src="/assets/team/Michiel.jpeg" alt="" class="rounded-full object-cover h-full w-full shadow-md" />
                                </div>
                    ...
                    <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><a href="#">Title blog 2</a></h2>
                        <p class="mb-5 font-light text-gray-500 dark:text-gray-400">Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.</p>
                        <div class="flex justify-between items-center">
                            <div class="flex items-center space-x-4">
